...
from src.product_evidence_harness.executive_summary import (
    build_executive_summary as build_base_summary,
)
...
def build_url_delivery_summary(result: Mapping[str, Any]) -> dict[str, Any]:
    """Build the canonical URL-delivery-first summary."""

    summary = build_base_summary(result)
...
def attach_url_delivery_summary(result: dict[str, Any]) -> dict[str, Any]:
