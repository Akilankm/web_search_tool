    ...
    def resolve(self, product: ProductInput, progress: ProgressCallback | None = None) -> ResolutionResult:
        ...
        try:
            ...
            emit(
                ...
                "COMPLETE",
                f"Built {len(interpretation.hypotheses)} product hypothesis/hypotheses.",
            ...
            emit(
                ...
                "COMPLETE",
                f"Collected {len(campaign.candidates)} structurally product-like URL candidates using {len(campaign.actions)} search credits.",
            )
