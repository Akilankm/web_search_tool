...
Before final handoff, the champion candidate must pass repeated quality confirmation checks. By default, the system should confirm the same URL three times after the candidate passes the normal production evidence gate.
...
Coding readiness cannot be ready unless a production-ready exact champion exists and champion confirmation passed.
